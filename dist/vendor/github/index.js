...
var require_redirect_interceptor = __commonJS({
  "node_modules/undici/lib/interceptor/redirect-interceptor.js"(exports, module) {
    ...
    function createRedirectInterceptor({ maxRedirections: defaultMaxRedirections }) {
      return (dispatch) => {
        return /* @__PURE__ */ __name(function Intercept(opts, handler2) {
...
var require_mock_utils = __commonJS({
  "node_modules/undici/lib/mock/mock-utils.js"(exports, module) {
    ...
    function buildMockDispatch() {
      ...
      return /* @__PURE__ */ __name(function dispatch(opts, handler2) {
...
var require_redirect = __commonJS({
  "node_modules/undici/lib/interceptor/redirect.js"(exports, module) {
    ...
    module.exports = (opts) => {
      ...
      return (dispatch) => {
        return /* @__PURE__ */ __name(function redirectInterceptor(opts2, handler2) {
...
var require_retry = __commonJS({
  "node_modules/undici/lib/interceptor/retry.js"(exports, module) {
    ...
    module.exports = (globalOpts) => {
      return (dispatch) => {
        return /* @__PURE__ */ __name(function retryInterceptor(opts, handler2) {
          return dispatch(
            opts,
            new RetryHandler(
...
var require_dns = __commonJS({
  "node_modules/undici/lib/interceptor/dns.js"(exports, module) {
    ...
    module.exports = (interceptorOpts) => {
      ...
      return (dispatch) => {
        return /* @__PURE__ */ __name(function dnsInterceptor(origDispatchOpts, handler2) {
...
import * as httpClient from "../core/index.js";
...
function getProxyFetch(destinationUrl) {
  ...
  const proxyFetch = /* @__PURE__ */ __name((url, opts) => __awaiter(this, void 0, void 0, function* () {
...
__name(getUserAgentWithOrchestrationId, "getUserAgentWithOrchestrationId");
...
var isUnstringifiable = /* @__PURE__ */ __name((val) => val === void 0 || typeof val === "function" || typeof val === "symbol", "isUnstringifiable");
var isRawJSON = /* @__PURE__ */ __name((val) => val !== null && typeof val === "object" && val.constructor && val.constructor.name === "RawJSON", "isRawJSON");
var stringifyIteratively = /* @__PURE__ */ __name((rootValue, replacer, spaceParam) => {
  let space = "";
  ...
  const prepareVal = /* @__PURE__ */ __name((parent, key, val) => {
  ...
  return chunks.join("");
}, "stringifyIteratively");
var JSONStringify = /* @__PURE__ */ __name((value, replacer, space) => {
  try {
    const supportsRawJSON = "rawJSON" in JSON;
    if (supportsRawJSON) {
...
}, "convertMarkedBigIntsReviver");
var JSONParseV2 = /* @__PURE__ */ __name((text, reviver) => {
...
var applyReviverIteratively = /* @__PURE__ */ __name((parsed, userReviver) => {
  ...
  return rootHolder[""];
}, "applyReviverIteratively");
var serializeBigInts = /* @__PURE__ */ __name((text) => {
  return text.replace(
...
var JSONParse = /* @__PURE__ */ __name((text, reviver) => {
